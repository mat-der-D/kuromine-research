...
Partial answer (S35): Theorem T is a genuine new positive constraint but soft-obstructed like all
local conditions. Practical value: cheapest large search cut ($\geq5\times$), composing
independently with Theorem M (size) and the $p$-adic portrait.
...
**Ongoing literature watch.** As of Session 35, **24 consecutive negative confirmations** of the
